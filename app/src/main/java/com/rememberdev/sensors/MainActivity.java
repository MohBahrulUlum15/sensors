...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    ImageView imgAllSensor, imgLightSensor, imgProximitySensor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgAllSensor.setOnClickListener(this::onClick);
        imgLightSensor.setOnClickListener(this::onClick);
        imgProximitySensor.setOnClickListener(this::onClick);
    }
